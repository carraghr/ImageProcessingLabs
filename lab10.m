...
%{
    ...
    Rows in B are removed for the same reason. The black spaces its a
    positive wave which adds the points around it together making the
    spaces brighter. 
